...
public class SallerProfileResponse implements Serializable {
	...
	public SallerProfileDto getData() {
		return data;
	}

	public void setData(SallerProfileDto data) {
		this.data = data;
	}
