...
public class SallerProfileResponses implements Serializable {
	...
	@JsonProperty("data")
	private List<SallerProfileDto> data;
	...
	public List<SallerProfileDto> getData() {
		return data;
	}

	public void setData(List<SallerProfileDto> data) {
		this.data = data;
	}
