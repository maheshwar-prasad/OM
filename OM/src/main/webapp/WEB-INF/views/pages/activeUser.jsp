...
<script type="text/javascript" src="<c:url value='/static/bower_components/jquery/dist/jquery.min.js'/>"></script>
 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="${pageContext.request.contextPath}/createUser" class="btn btn-block btn-primary btn-flat">Create User +</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    <!-- /.content -->
    <input type="hidden" id="activeUserUrl" value="${pageContext.request.contextPath}/activeUser">
  </div>
  <!-- /.content-wrapper -->
