...
<div class="content-wrapper">
								...
								<c:forEach items="${userList}" var="user" varStatus="status">
									<tr>
										...
										<td><span class="label label-success"
											...
											onclick="javascript:edit(${user.user_id},'2');">Pending</span>&nbsp;<span
											class="label label-danger"
											onclick="javascript:edit(${user.user_id},'0');">Denied</span></td>
									</tr>
								</c:forEach>
							</tbody>
							<tfoot>
	...
	<input type="hidden" id="activeItemUrl"
		value="${pageContext.request.contextPath}/apiItems">
</div>
<!-- /.content-wrapper -->
<script type="text/javascript">
  ...
  function edit(userId,status){
	  var routing = $("#routing"+userId).val();
	  var path=$('#activeItemUrl').val();
	  var pathname = window.location.pathname;  
	    $.ajax({
	        url: "/OM/permissionUpdate/" + userId+"/"+status+"/"+routing,
