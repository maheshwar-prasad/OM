...
<div class="lockscreen-wrapper">
 ...
 <div class="lockscreen-name">Online Marts<br /></div>
  ...
  <div class="lockscreen-item">
    ...
    <form action="${pageContext.request.contextPath}/index" class="lockscreen-credentials">
  ...
  <div class="text-center">
    <a href="${pageContext.request.contextPath}/createCustomer">Or sign in as a different user</a>
  </div>
