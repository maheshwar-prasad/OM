        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="${pageContext.request.contextPath}/offer" class="btn btn-block btn-primary btn-flat">Create Offer +</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <td>${offer.active}</td>
                  <td><a class="fa fa-fw fa-bank" href="${pageContext.request.contextPath}/get-offer?id=${offer.id}"></a> <a class="fa fa-fw fa-trash-o" href="${pageContext.request.contextPath}/delete-offer?id=${offer.id}"></a></td>
                </tr>
               </c:forEach>
               </c:if>
                </tbody>
...
<script type="text/javascript">
 ...
 function deleteOffer(var id){
	window.location = "${pageContext.request.contextPath}/delete-offer?id="+id;
 }
