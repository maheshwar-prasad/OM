    ...
    <div class="box box-default">
            ...
            <div class="col-md-6">
              <div class="form-group">
               <label for="exampleInputEmail1">Type</label> 
                <input type="text" class="form-control" id="type" name="type" value="${item.type}" placeholder="" disabled="disabled">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="quantity" value="${item.quantity}" name="quantity" placeholder="Enter Quantity">
                </div>
              <!-- /.form-group -->
            </div>
            <!-- /.col -->
             <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="itemName"  value="${item.itemName}" name="itemName" placeholder="Enter Name">
                </div>
              <!-- /.form-group -->
              <div class="form-group">
                  <label for="exampleInputEmail1">Available Quantity</label>
                  <input type="text" class="form-control" id="availableQty" value="${item.availableQty}" name="availableQty" placeholder="Enter Available Qty.">
                </div>
              <!-- /.form-group -->
            </div>
             <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="oldPrice" value="${item.oldPrice}" name="oldPrice" placeholder="Enter Old Price">
                </div>
              <!-- /.form-group -->
              <div class="form-group">
                  <label for="exampleInputEmail1">Current Price(Rs.)</label>
                  <input type="text" class="form-control" id="currentprice" value="${item.currentPrice}" name="currentprice" placeholder="Enter Current Price">
                </div>
              <!-- /.form-group -->
            </div>
             <div class="col-md-6">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="pack" value="${item.pack}" name="pack" placeholder="Enter Pack(Kg/Gm/ltr/ml)">
                </div>
              <!-- /.form-group -->
            </div>
            <!-- /.col -->
        ...
        <div class="box-footer">
                <button type="submit" id="btn-save" class="btn btn-primary">Submit</button>
                 <button type="button" id="back"  class="btn btn-default"  onclick="javascript:backItem();" >Back</button>
