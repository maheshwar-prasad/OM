			...
			<div class='col-md-3 sidebar'>
				<div class="sidebar-module-container">
					<div class="home-banner outer-top-n">
						<img
							src="${pageContext.request.contextPath}/static/website/assets/images/banners/LHS-banner.jpg"
							alt="Image">
					</div>
									...
									<div class="product-info text-left m-t-20">
										...
										<div class="product-price">
											<span class="price"> $600.00 </span> <span
												class="price-before-discount">$80.00</span>
							...
							<div class="item">
								<div class="products">
									<div class="hot-deal-wrapper">
										<div class="image">
											<img
												src="${pageContext.request.contextPath}/static/website/assets/images/products/p7.jpg"
												alt="">
										</div>
										<div class="sale-offer-tag">
											<span>35%<br>off
					...
					<div class="row  wow fadeInUp">
							...
							<div
								...
								<div id="owl-single-product">
									...
									<div class="single-product-gallery-item" id="slide2">
										<a data-lightbox="image-1" data-title="Gallery"
											href="${pageContext.request.contextPath}/static/website/assets/images/products/p9.jpg">
											<img class="img-responsive" alt=""
											src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
											data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p9.jpg" />
										</a>
									</div>
									<!-- /.single-product-gallery-item -->
									...
									<div class="single-product-gallery-item" id="slide3">
										<a data-lightbox="image-1" data-title="Gallery"
											href="${pageContext.request.contextPath}/static/website/assets/images/products/p10.jpg">
											<img class="img-responsive" alt=""
											src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
											data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p10.jpg" />
										</a>
									</div>
									<!-- /.single-product-gallery-item -->
									...
									<div class="single-product-gallery-item" id="slide4">
										<a data-lightbox="image-1" data-title="Gallery"
											href="${pageContext.request.contextPath}/static/website/assets/images/products/p11.jpg">
											<img class="img-responsive" alt=""
											src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
											data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p11.jpg" />
										</a>
									</div>
									<!-- /.single-product-gallery-item -->
									...
									<div class="single-product-gallery-item" id="slide5">
										<a data-lightbox="image-1" data-title="Gallery"
											href="${pageContext.request.contextPath}/static/website/assets/images/products/p12.jpg">
											<img class="img-responsive" alt=""
											src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
											data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p12.jpg" />
										</a>
									</div>
									<!-- /.single-product-gallery-item -->
									...
									<div class="single-product-gallery-item" id="slide6">
										<a data-lightbox="image-1" data-title="Gallery"
											href="${pageContext.request.contextPath}/static/website/assets/images/products/p13.jpg">
											<img class="img-responsive" alt=""
											src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
											data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p13.jpg" />
										</a>
									</div>
									<!-- /.single-product-gallery-item -->
									...
									<div class="single-product-gallery-item" id="slide7">
										<a data-lightbox="image-1" data-title="Gallery"
											href="${pageContext.request.contextPath}/static/website/assets/images/products/p14.jpg">
											<img class="img-responsive" alt=""
											src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
											data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p14.jpg" />
										</a>
									</div>
									<!-- /.single-product-gallery-item -->
									...
									<div class="single-product-gallery-item" id="slide8">
										<a data-lightbox="image-1" data-title="Gallery"
											href="${pageContext.request.contextPath}/static/website/assets/images/products/p15.jpg">
											<img class="img-responsive" alt=""
											src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
											data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p15.jpg" />
										</a>
									</div>
									<!-- /.single-product-gallery-item -->
									...
									<div class="single-product-gallery-item" id="slide9">
										<a data-lightbox="image-1" data-title="Gallery"
											href="${pageContext.request.contextPath}/static/website/assets/images/products/p16.jpg">
											<img class="img-responsive" alt=""
											src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
											data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p16.jpg" />
										</a>
									</div>
									<!-- /.single-product-gallery-item -->
									...
									<div id="owl-single-product-thumbnails">
										<div class="item">
											<a class="horizontal-thumb active"
												...
												alt=""
												src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
												data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p17.jpg" />
											</a>
										</div>

										<div class="item">
											<a class="horizontal-thumb" data-target="#owl-single-product"
												data-slide="2" href="#slide2"> <img
												class="img-responsive" width="85" alt=""
												src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
												data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p18.jpg" />
											</a>
										</div>
										<div class="item">

											<a class="horizontal-thumb" data-target="#owl-single-product"
												data-slide="3" href="#slide3"> <img
												class="img-responsive" width="85" alt=""
												src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
												data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p19.jpg" />
											</a>
										</div>
										<div class="item">

											<a class="horizontal-thumb" data-target="#owl-single-product"
												data-slide="4" href="#slide4"> <img
												class="img-responsive" width="85" alt=""
												src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
												data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p20.jpg" />
											</a>
										</div>
										<div class="item">

											<a class="horizontal-thumb" data-target="#owl-single-product"
												data-slide="5" href="#slide5"> <img
												class="img-responsive" width="85" alt=""
												src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
												data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p21.jpg" />
											</a>
										</div>
										<div class="item">

											<a class="horizontal-thumb" data-target="#owl-single-product"
												data-slide="6" href="#slide6"> <img
												class="img-responsive" width="85" alt=""
												src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
												data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p22.jpg" />
											</a>
										</div>
										<div class="item">

											<a class="horizontal-thumb" data-target="#owl-single-product"
												data-slide="7" href="#slide7"> <img
												class="img-responsive" width="85" alt=""
												src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
												data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p23.jpg" />
											</a>
										</div>
										<div class="item">

											<a class="horizontal-thumb" data-target="#owl-single-product"
												data-slide="8" href="#slide8"> <img
												class="img-responsive" width="85" alt=""
												src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
												data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p24.jpg" />
											</a>
										</div>
										<div class="item">

											<a class="horizontal-thumb" data-target="#owl-single-product"
												data-slide="9" href="#slide9"> <img
												class="img-responsive" width="85" alt=""
												src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
												data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p25.jpg" />
											</a>
										</div>
									</div>
						...
						<div class='col-sm-6 col-md-7 product-info-block'>
							<div class="product-info">
								<h1 class="name">${stock.dto.itemName}</h1>
								...
								<div class="description-container m-t-20">${stock.dto.description}</div>
										...
										<div class="col-sm-6">
											<div class="price-box">
												<span class="price">INR. &#x20b9;
													${stock.dto.unitPrice}&#x20b9;&#x20b9;</span> <span class="price-strike">INR.
													&#x20b9; ${stock.dto.mrp}</span>
											</div>
										</div>
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">
											...
											aliquip ex ea commodo consequat.<br> <br> Duis aute
											...
											<div class="form-container">
												...
												<div class="form-group">
													<label for="exampleInputTag">Add Your Tags: </label> <input
														type="email" id="exampleInputTag" class="form-control txt">
										...
										<form role="form" class="form-inline form-cnt">
											<div class="form-group">
												<label>&nbsp;</label> <span class="text col-md-offset-3">Use
													spaces to separate tags. Use single quotes (') for phrases.</span>
											</div>
										</form>
										<!-- /.form-cnt -->
									...
									<div class="product-info text-left">
										...
										<div class="product-price">
											<span class="price"> &#x20b9; 65.99 </span> <span
												class="price-before-discount">&#x20b9; 80</span>
							...
							<div class="products">
								...
								<div class="product">
									<div class="product-image">
										<div class="image">
											<a href="detail.html"><img
												src="${pageContext.request.contextPath}/static/website/assets/images/products/p4.jpg"
												alt=""></a>
										</div>
										<!-- /.image -->
								...
								<div class="product">
									<div class="product-image">
										<div class="image">
											<a href="detail.html"><img
												src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
												data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p5.jpg"
												alt=""></a>
										</div>
										<!-- /.image -->
								...
								<div class="product">
									<div class="product-image">
										<div class="image">
											<a href="detail.html"><img
												src="${pageContext.request.contextPath}/static/website/assets/images/blank.gif"
												data-echo="${pageContext.request.contextPath}/static/website/assets/images/products/p6.jpg"
												alt=""></a>
										</div>
										<!-- /.image -->
