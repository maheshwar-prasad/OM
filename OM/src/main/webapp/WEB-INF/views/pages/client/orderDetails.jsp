			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">
							<a
								href="${pageContext.request.contextPath}/clientDeleteOrder?order-number=${orderDetail.orderNumber}"
								class="btn btn-block btn-primary btn-flat">Delete Order</a>
						</h3>
						<h3 class="box-title">
							<a
								href="${pageContext.request.contextPath}/clientMarkDelivered?order-number=${orderDetail.orderNumber}"
								class="btn btn-block btn-primary btn-flat">Mark Delivered</a>
						</h3>
						<h3 class="box-title">
							<a
								href="${pageContext.request.contextPath}/clientCancelOrder?order-number=${orderDetail.orderNumber}"
								class="btn btn-block btn-primary btn-flat">Cancel Order</a>
						</h3>
						<h3 class="box-title">
							<a
								href="${pageContext.request.contextPath}/clientAcceptOrder?order-number=${orderDetail.orderNumber}"
