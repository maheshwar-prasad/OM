                    ...
                    <li>
                      <div class="yamm-content ">
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image"> <img class="img-responsive" src="${pageContext.request.contextPath}/static/website/assets/images/brands/brand5.png" src="${pageContext.request.contextPath}/static/website/assets/images/banners/top-menu-banner.jpg" alt=""> </div>
                          <!-- /.yamm-content --> 
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div class="yamm-content">
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner"> <a href="#"><img alt="" src="${pageContext.request.contextPath}/static/website/assets/images/brands/brand5.png" ></a> </div>
                        </div>
                        <!-- /.row --> 
                      </div>
                      <!-- /.yamm-content --> </li>
