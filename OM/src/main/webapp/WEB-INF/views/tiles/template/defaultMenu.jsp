      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
 		...
 		<li class="treeview">
          ...
          <li><a href="${pageContext.request.contextPath}/itemTypeList"><i class="fa fa-circle-o"></i>Item Type List</a></li>
            <%-- <li><a href="${pageContext.request.contextPath}/itemType"><i class="fa fa-circle-o"></i> Item Type</a></li> --%>
             <li><a href="${pageContext.request.contextPath}/apiItems"><i class="fa fa-book"></i> <span>ItemsList</span></a></li>
             <li><a href="${pageContext.request.contextPath}/items"><i class="fa fa-book"></i> <span>Items</span></a></li>
  	  ...
  	  <li class="treeview">
          ...
          <ul class="treeview-menu">
           <li><a href="pages/tables/simple.html"><i class="fa fa-circle-o"></i>Database Setting</a></li>
           <li><a href="pages/tables/data.html"><i class="fa fa-circle-o"></i> Email Configuration</a></li>
           <li><a href="pages/tables/data.html"><i class="fa fa-circle-o"></i> SMS Configuration</a></li>
           <li><a href="pages/tables/data.html"><i class="fa fa-circle-o"></i>Page Configuration</a></li>
          </ul>
        </li>   
