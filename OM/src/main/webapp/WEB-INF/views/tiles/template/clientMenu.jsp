	...
	<section class="sidebar">
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img
					src="${pageContext.request.contextPath}/static/dist/img/profile.png"
					class="img-circle" alt="User Image">
			</div>
			<div class="pull-left info">
				<p>${user.name}</p>
				<a href="#"><i class="fa fa-circle text-success"></i>
					Assiduous Technologies</a>
			</div>
		</div>
		<!-- search form -->
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li><a href="${pageContext.request.contextPath}/clientdashboard"><i
			...
			<li class="treeview"><a href="#"> <i class="fa fa-folder"></i>
				...
				<ul class="treeview-menu">
					<li><a href="${pageContext.request.contextPath}/clientmember"><i
							class="fa fa-circle-o"></i>Member</a></li>
					<li><a
						href="${pageContext.request.contextPath}/clientitemTypeList"><i
							class="fa fa-circle-o"></i>Category</a></li>
					<li><a href="${pageContext.request.contextPath}/clientItems"><i
							class="fa fa-book"></i> <span>Items</span></a></li>
					<li><a href="${pageContext.request.contextPath}/clientOffers"><i
							class="fa fa-circle-o"></i>Offer</a>
				</ul></li>
			<li class="treeview"><a href="#"> <i class="fa fa-laptop"></i>
				...
				<ul class="treeview-menu">
					<li><a href="${pageContext.request.contextPath}/clientStock"><i
							class="fa fa-book"></i> <span>Stock</span></a></li>
				</ul></li>
			<li class="treeview"><a href="#"> <i class="fa fa-diamond"></i>
					<span>Order Summary</span> <span class="pull-right-container">
						<i class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="${pageContext.request.contextPath}/clientOrder"><i
							class="fa fa-book"></i> <span>Order</span></a></li>
				</ul></li>
			<%-- <li class="treeview">
          <a href="#">
