...
@RequestMapping(value = DCSBalajiConstant.Symbol.SLASH + DCSBalajiConstant.APIConstant.PATH_PATTERN
		+ DCSBalajiConstant.Symbol.SLASH + DCSBalajiConstant.RequestPath.OFFER)
@Api(value = "Offer Master Controller")
@EnableSwagger
public class OfferController {
	...
	public CommonResponseDto<OfferDto> save(@Valid @RequestBody OfferDto dto, HttpServletRequest request)
			throws RuntimeException {
		CommonResponseDto<OfferDto> response = new CommonResponseDto<>();
		response.setData(service.loadOffer(service.saveOffer(dto)));
		return response;
	}
	...
	@PostMapping(value = APIConstant.APIPath.SAVE_ALL, consumes = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE }, produces = { MediaType.APPLICATION_JSON_VALUE,
					MediaType.APPLICATION_XML_VALUE })
	public CommonResponsesDto<OfferDto> saveAll(@Valid @RequestBody List<OfferDto> dto, HttpServletRequest request)
			throws RuntimeException {
		CommonResponsesDto<OfferDto> response = new CommonResponsesDto<>();
		response.setData(service.loadOffer(service.saveOffer(dto)));
		return response;
	}
	...
	@PutMapping(value = APIConstant.APIPath.UPDATE, consumes = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE }, produces = { MediaType.APPLICATION_JSON_VALUE,
					MediaType.APPLICATION_XML_VALUE })
	public CommonResponseDto<OfferDto> update(@Valid @RequestBody OfferDto dto, HttpServletRequest request)
			throws RuntimeException {
		CommonResponseDto<OfferDto> response = new CommonResponseDto<>();
		response.setData(service.loadOffer(service.updateOffer(dto)));
		return response;
	}
	...
	@PutMapping(value = APIConstant.APIPath.UPDATE_ALL, consumes = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE }, produces = { MediaType.APPLICATION_JSON_VALUE,
					MediaType.APPLICATION_XML_VALUE })
	public CommonResponsesDto<OfferDto> updateAll(@Valid @RequestBody List<OfferDto> dto, HttpServletRequest request)
			throws RuntimeException {
		CommonResponsesDto<OfferDto> response = new CommonResponsesDto<>();
	...
	@PutMapping(value = APIConstant.APIPath.ACTIVE, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE })
	public CommonResponseDto<OfferDto> active(@PathVariable(APIConstant.PathVariable.ID) Integer ID,
	...
	@PutMapping(value = APIConstant.APIPath.ACTIVE_ALL, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE })
	public CommonResponsesDto<OfferDto> activeAll(@PathVariable(APIConstant.PathVariable.IDS) Set<Integer> IDS,
			HttpServletRequest request) throws RuntimeException {
		CommonResponsesDto<OfferDto> response = new CommonResponsesDto<>();
	...
	@DeleteMapping(value = APIConstant.APIPath.DEACTIVE, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE })
	public CommonResponseDto<OfferDto> deactive(@PathVariable(APIConstant.PathVariable.ID) Integer ID,
			HttpServletRequest request) throws RuntimeException {
		CommonResponseDto<OfferDto> response = new CommonResponseDto<>();
	...
	@DeleteMapping(value = APIConstant.APIPath.DEACTIVE_ALL, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE })
	public CommonResponsesDto<OfferDto> deactiveAll(@PathVariable(APIConstant.PathVariable.IDS) Set<Integer> IDS,
			HttpServletRequest request) throws RuntimeException {
		CommonResponsesDto<OfferDto> response = new CommonResponsesDto<>();
	...
	@GetMapping(value = APIConstant.APIPath.SEARCH, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE })
	public CommonResponsesDto<OfferDto> search(
	...
	@GetMapping(value = APIConstant.APIPath.FIND_ALL_WITH_PAGE, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE })
	public CommonResponsesDto<OfferDto> find(
			@RequestHeader(value = HeaderConstant.ONLY_ACTIVE, required = false, defaultValue = "false") boolean ONLY_ACTIVE,
			...
			HttpServletRequest request) throws RuntimeException {
		CommonResponsesDto<OfferDto> response = new CommonResponsesDto<>();
		response.setData(service.findOffer(PAGE, SIZE, SORT_BY, SORT_ORDER, ONLY_ACTIVE));
		return response;
	}
	...
	public CommonResponsesDto<OfferDto> find(
			...
			HttpServletRequest request) throws RuntimeException {
		CommonResponsesDto<OfferDto> response = new CommonResponsesDto<>();
		response.setData(service.findOffer(SORT_BY, SORT_ORDER, ONLY_ACTIVE));
		return response;
	}
	...
	public CommonResponsesDto<OfferDto> findIncluding(
			@RequestHeader(value = HeaderConstant.ONLY_ACTIVE, required = false, defaultValue = "false") boolean ONLY_ACTIVE,
			@PathVariable(value = APIConstant.PathVariable.PAGE, required = false) Integer PAGE,
			@PathVariable(value = APIConstant.PathVariable.SIZE, required = false) Integer SIZE,
			@PathVariable(value = APIConstant.PathVariable.SORT_BY, required = false) String SORT_BY,
	...
	@GetMapping(value = APIConstant.APIPath.FIND_ALL_SORTED_AND_INCLUSION, produces = {
			MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	public CommonResponsesDto<OfferDto> findSorted(
			@RequestHeader(value = HeaderConstant.ONLY_ACTIVE, required = false, defaultValue = "false") boolean ONLY_ACTIVE,
			@PathVariable(value = APIConstant.PathVariable.SORT_BY, required = false) String SORT_BY,
			@PathVariable(value = APIConstant.PathVariable.SORT_ORDER, required = false) SortOrder SORT_ORDER,
			HttpServletRequest request) throws RuntimeException {
	...
	@LogAfter
	@LogExceptionaly
	@GetMapping(value = DCSBalajiConstant.APIPath.GET_OFFER, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE })
	public CommonResponsesDto<CustomerOffer> getOrder(@RequestHeader(DCSBalajiConstant.Header.CUST_EMAIL) String EMAIL,
			@RequestHeader(DCSBalajiConstant.Header.CUST_MOB) String MOB, HttpServletRequest request) throws Exception {
		CommonResponsesDto<CustomerOffer> dto = new CommonResponsesDto<>();
		dto.setData(service.getOffers(MOB, EMAIL));
		return dto;
	}
