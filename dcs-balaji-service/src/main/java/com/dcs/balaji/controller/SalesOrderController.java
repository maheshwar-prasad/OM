...
@RequestMapping(value = DCSBalajiConstant.Symbol.SLASH + DCSBalajiConstant.APIConstant.PATH_PATTERN
		+ DCSBalajiConstant.Symbol.SLASH + DCSBalajiConstant.RequestPath.SALES_ORDER)
@Api(value = "SalesOrder Master Controller")
@EnableSwagger
public class SalesOrderController {
	...
	public CommonResponseDto<SalesOrderDto> save(@Valid @RequestBody SalesOrderDto dto, HttpServletRequest request)
			throws RuntimeException {
		CommonResponseDto<SalesOrderDto> response = new CommonResponseDto<>();
		response.setData(service.loadSalesOrder(service.saveSalesOrder(dto)));
		return response;
	}
	...
	@PostMapping(value = APIConstant.APIPath.SAVE_ALL, consumes = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE }, produces = { MediaType.APPLICATION_JSON_VALUE,
					MediaType.APPLICATION_XML_VALUE })
	public CommonResponsesDto<SalesOrderDto> saveAll(@Valid @RequestBody List<SalesOrderDto> dto,
			HttpServletRequest request) throws RuntimeException {
		CommonResponsesDto<SalesOrderDto> response = new CommonResponsesDto<>();
		response.setData(service.loadSalesOrder(service.saveSalesOrder(dto)));
		return response;
	}
	...
	@PutMapping(value = APIConstant.APIPath.UPDATE, consumes = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE }, produces = { MediaType.APPLICATION_JSON_VALUE,
					MediaType.APPLICATION_XML_VALUE })
	public CommonResponseDto<SalesOrderDto> update(@Valid @RequestBody SalesOrderDto dto, HttpServletRequest request)
			throws RuntimeException {
		CommonResponseDto<SalesOrderDto> response = new CommonResponseDto<>();
		response.setData(service.loadSalesOrder(service.updateSalesOrder(dto)));
		return response;
	}
	...
	@PutMapping(value = APIConstant.APIPath.UPDATE_ALL, consumes = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE }, produces = { MediaType.APPLICATION_JSON_VALUE,
					MediaType.APPLICATION_XML_VALUE })
	public CommonResponsesDto<SalesOrderDto> updateAll(@Valid @RequestBody List<SalesOrderDto> dto,
			HttpServletRequest request) throws RuntimeException {
		CommonResponsesDto<SalesOrderDto> response = new CommonResponsesDto<>();
		service.updateSalesOrder(dto);
	...
	@GetMapping(value = APIConstant.APIPath.SEARCH, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE })
	public CommonResponsesDto<SalesOrderDto> search(
	...
	@GetMapping(value = APIConstant.APIPath.FIND_ALL_WITH_PAGE, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE })
	public CommonResponsesDto<SalesOrderDto> find(
			@RequestHeader(value = HeaderConstant.ONLY_ACTIVE, required = false, defaultValue = "false") boolean ONLY_ACTIVE,
			...
			HttpServletRequest request) throws RuntimeException {
		CommonResponsesDto<SalesOrderDto> response = new CommonResponsesDto<>();
		response.setData(service.findSalesOrder(PAGE, SIZE, SORT_BY, SORT_ORDER, ONLY_ACTIVE));
		return response;
	}
	...
	public CommonResponsesDto<SalesOrderDto> find(
			...
			HttpServletRequest request) throws RuntimeException {
		CommonResponsesDto<SalesOrderDto> response = new CommonResponsesDto<>();
		response.setData(service.findSalesOrder(SORT_BY, SORT_ORDER, ONLY_ACTIVE));
		return response;
	}
	...
	public CommonResponsesDto<SalesOrderDto> findIncluding(
			@RequestHeader(value = HeaderConstant.ONLY_ACTIVE, required = false, defaultValue = "false") boolean ONLY_ACTIVE,
			@PathVariable(value = APIConstant.PathVariable.PAGE, required = false) Integer PAGE,
			@PathVariable(value = APIConstant.PathVariable.SIZE, required = false) Integer SIZE,
			@PathVariable(value = APIConstant.PathVariable.SORT_BY, required = false) String SORT_BY,
	...
	@GetMapping(value = APIConstant.APIPath.FIND_ALL_SORTED_AND_INCLUSION, produces = {
			MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	public CommonResponsesDto<SalesOrderDto> findSorted(
			@RequestHeader(value = HeaderConstant.ONLY_ACTIVE, required = false, defaultValue = "false") boolean ONLY_ACTIVE,
			@PathVariable(value = APIConstant.PathVariable.SORT_BY, required = false) String SORT_BY,
			@PathVariable(value = APIConstant.PathVariable.SORT_ORDER, required = false) SortOrder SORT_ORDER,
			HttpServletRequest request) throws RuntimeException {
